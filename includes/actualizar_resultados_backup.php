...
$archivoResultados = DATA_PATH . 'resultados.csv';
...
foreach ($datosApi['events'] as $evento) {
    ...
    fputcsv(
        ...
        [
            ...
            intval($homeTeam['score']),
            intval($awayTeam['score']),
            $evento['season']['slug']
            // $fase
        ],
        ",",
...
echo date('Y-m-d H:i:s') . " - ¡Éxito! Archivo resultados.csv actualizado con " . ($contadorPartidos - 1) . " partidos finalizados.\n";